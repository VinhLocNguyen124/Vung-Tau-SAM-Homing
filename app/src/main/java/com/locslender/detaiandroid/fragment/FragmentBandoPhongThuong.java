...
public class FragmentBandoPhongThuong extends Fragment implements OnMapReadyCallback {
...
//    }
    ...
    private ArrayList<LatLngPhongThuong> arrLatLngFRM_THO;
    ...
    private void recieveDataLatLngArrayPhongGhep() {
        ...
        if (bundle1 != null) {
            arrLatLngFRM_THO = (ArrayList<LatLngPhongThuong>) bundle1.getSerializable(PhongGhepActivity.KEY_MANG_THO_LATLNG);
        }
